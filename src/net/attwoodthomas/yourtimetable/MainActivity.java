	...
	public void onCreate(Bundle savedInstanceState) {
		...
		getTimetable.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Log.d("Mian", "0.5");
				if (group1.getCheckedRadioButtonId() == 2131165187) {  // Check if it is Week A
					mWeek = "A";
				}
				...
				if (group2.getCheckedRadioButtonId() == 2131165191) { // Check if its Monday
					mDay = "Monday";
				}
				
				else if (group2.getCheckedRadioButtonId() == 2131165192) { // Check if its Tuesday
					mDay = "Tuesday";
				}
				
				else if (group2.getCheckedRadioButtonId() == 2131165193) { // Check if its Wednesday
					mDay = "Wednesday";
				}
				
				else if (group2.getCheckedRadioButtonId() == 2131165194) { // Check if its Thursday
					mDay = "Thursday";
				}
